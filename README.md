...
Also I am using [docker-compose](https://github.com/docker/compose) in order to build and run docker containers. Docker compose version must be 1.19.0 or higher in order to run nvidia-docker2 from inside of docker-compose.
